 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Tue May 23 12:27:26 2023
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME codeurMoteur
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
/* Output Port  0 */
#define OUT_PORT_0_NAME       compteur
...
{
    real_T *compteur = (real_T *) ssGetOutputPortRealSignal(S, 0);
    real_T *omega = (real_T *) ssGetOutputPortRealSignal(S, 1);
    const real_T *xD = ssGetDiscStates(S);

    codeurMoteur_Outputs_wrapper(compteur, omega, xD);
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
    ...
    codeurMoteur_Update_wrapper(compteur, omega, xD);
